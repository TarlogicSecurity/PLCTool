...
typedef enum
{
  ...
  DLMS_SOURCE_DIAGNOSTIC_APPLICATION_CALLING_AP_INVOCATION_IDENTIFIER_NOT_RECOGNIZED =
      4,
  ...
  DLMS_SOURCE_DIAGNOSTIC_APPLICATION_CALLING_AE_INVOCATION_IDENTIFIER_NOT_RECOGNIZED =
      6,
  ...
  DLMS_SOURCE_DIAGNOSTIC_APPLICATION_CALLED_AP_INVOCATION_IDENTIFIER_NOT_RECOGNIZED =
      8,
  ...
  DLMS_SOURCE_DIAGNOSTIC_APPLICATION_CALLED_AE_INVOCATION_IDENTIFIER_NOT_RECOGNIZED =
      10,
...
enum DLMS_OPTICAL_PROTOCOL_MODE
{
  ...
  */
  ...
  /*
   ...
   Using this enumeration value all other attributes of this IC are not
   applicable.
  */
...
typedef enum
{
  ...
  */
  ...
  The IP-Option-length and IP-Option-Data values are specified in STD0005 / RFC
  791.
  */
